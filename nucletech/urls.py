...
admin.site.site_header = "NUCLETECH"
admin.site.site_title = "Nucletech | Intelligent By Nature"
...
urlpatterns = [
    ...
    url(r'^bots/', include('bot.urls')), # Bots for giving demo
]
